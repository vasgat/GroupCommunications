...
public interface SecretForumFactory {
     ...
     */
    SecretForum createSecretForum(@Nullable String name, @Nullable PeerId owner);
     ...
     * @return
     */
    SecretForum createSecretForum(@Nullable String name, @Nullable PeerId owner, byte[] salt);
}
